<template>
    ...
    <div v-else>
        <h1 class="text-xl font-bold mb-5">{{ isEditProduct ? `Editar producto` : `Nuevo producto` }}</h1>
            ...
            <div class="w-full flex min-h-[600px] mb-5">
                    ...
                    <div class="mt-5">
                        <label class="input input-bordered flex items-center gap-2 mb-2">
                            <input type="text" placeholder="Nombre del producto" class="grow" id="productName"
                                name="productName" autocomplete="name" v-model="product.productName">
                            <BoxIcon />
                        </label>
                        <select class="select select-bordered w-full max-w-xs" name="categoria" id="categoria"
                            ...
                            <option v-for="categoria in categoriaStore.categoriasAll" :key="categoria.id"
                                class="text-base" :value="categoria.id">
                ...
                <section class="w-full">
                    ...
                    <div class="flex gap-2 flex-wrap">
                        <CardPieza v-for="(pieza, index) in product.piezas" :key="pieza.descripcion" :pieza="pieza"
...
const { handleDeletePieza, handleNewPieza, handleSubmitFormProducto, togglePopup, setProductEdit, product, showModalPieza, isEditProduct, isLoadingForm } = useFormProduct()
