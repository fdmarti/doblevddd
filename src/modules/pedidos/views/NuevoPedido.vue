<template>
  <div>
    ...
    {{ pedidosStore.newPedido }}
    <section class="flex justify-between">
      <button class="btn btn-outline" :disabled="currentStep === 0" @click="prevStep">
        Volver
      </button>
...
import { FormClientePedido, ConfirmarPedido } from '@pedidos/components';
